...
declare module 'pipelineinstance' {
  ...
  export class PipelineInstance extends ItemResource {
    ...
    getPluginInstances(
      ...
      timeout?: number
    ): Promise<PipelineInstancePluginInstanceList>;
    /**
...
declare module 'feed' {
  ...
  export class FeedList extends ListResource {
    ...
    getPipelineInstances(
      ...
      timeout?: number
    ): Promise<AllPipelineInstanceList>;
    /**
...
declare module 'index' {
  ...
  export {
    ...
    PipelineInstancePluginInstanceList,
    PipelineList,
    PipelinePluginList,
