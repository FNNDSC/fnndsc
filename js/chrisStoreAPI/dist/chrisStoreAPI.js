!(function(e) {
  ...
  function(e, t, n) {
    ...
    (function(t) {
      ...
      var u,
        a = {
          adapter: ('undefined' != typeof XMLHttpRequest ? (u = n(6)) : void 0 !== t && (u = n(6)),
          u),
          transformRequest: [
            function(e, t) {
              return (
    ...
    e.exports = function(e) {
      return new Promise(function(t, f) {
        ...
        if (
          ...
          (p.onerror = function() {
            f(a('Network Error', e, null, p)), (p = null);
          }),
          (p.ontimeout = function() {
 ...
 */
  ...
  function(e, t, n) {
    ...
    class s {
        ...
        return (
          ...
          (function e(o) {
            ...
            return new Promise((a, c) => {
              s._runAsyncTask(function*() {
                try {
                  let s = yield n._getPaginatedCollections(o);
                  for (let n of s) {
                    let o = [],
                      s = n.items;
                    for (let n of s) {
                      let s = r.default.getItemDescriptors(n);
                      for (let o of t) {
                        let t = r.default.getLinkRelationUrls(n, o);
                        !t.length || o in s || (s[o] = []);
                        for (let n of t) {
                          let t = yield e((yield i.get(n)).collection);
                          s[o] = s[o].concat(t);
                        }
                      }
                      o.push(s);
      ...
      _getPaginatedCollections(e) {
        let t = [e];
        const n = new o.default(this.auth, this.contentType, this.timeout);
        return new Promise(function(o, i) {
          s._runAsyncTask(function*() {
            try {
              let o = r.default.getLinkRelationUrls(e, 'next');
              for (; o.length; ) {
                let e = yield n.get(o[0]);
                (t = t.concat(e.collection)),
                  (o = r.default.getLinkRelationUrls(e.collection, 'next'));
              }
            } catch (e) {
              i(e);
            }
      ...
      getUser() {
        const e = this.storeUrl,
          t = new o.default(this.auth, this.contentType, this.timeout);
        return new Promise((n, o) => {
          s._runAsyncTask(function*() {
            let i;
            try {
              i = yield t.get(e);
              let n = r.default.getLinkRelationUrls(i.collection, 'user');
              i = yield t.get(n[0]);
            } catch (e) {
              o(e);
            }
      ...
      static createUser(e, t, n, r, i = 3e4) {
        const s = {
            template: {
              data: [
          ...
          u = new o.default(void 0, 'application/vnd.collection+json', i).post(e, s);
      ...
      static getAuthToken(e, t, n, r = 3e4) {
        const i = { username: t, password: n },
          s = new o.default(void 0, 'application/json', r).post(e, i);
        return new Promise((e, t) => {
          s.then(t => {
            e(t.token);
          }).catch(e => {
