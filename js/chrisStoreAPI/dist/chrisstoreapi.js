  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, v, d, y, m) {
        ...
        if (
          ...
          if (((g = { values: k ? j : x('values'), keys: y ? j : x('keys'), entries: E }), m))
    ...
    function(t, e, n) {
      ...
      var r = n(0),
        ...
        J = function(t, e, n) {
          return (
            ...
            o(M, e)
              ? (n.enumerable
                  ? (o(t, A) && t[A][e] && (t[A][e] = !1), (n = k(n, { enumerable: _(0, !1) })))
                  : (o(t, A) || T(t, A, _(1, {})), (t[A][e] = !0)),
                H(t, e, n))
              : T(t, e, n)
          );
        },
        ...
        W = function(t) {
          ...
          return (
            !(this === q && o(M, t) && !o(I, t)) &&
            (!(e || !o(this, t) || !o(M, t) || (o(this, A) && this[A][t])) || e)
          );
        },
        X = function(t, e) {
          if (((t = b(t)), (e = x(e, !0)), t !== q || !o(M, e) || o(I, e))) {
            var n = E(t, e);
            return !n || !o(M, e) || (o(t, A) && t[A][e]) || (n.enumerable = !0), n;
          }
        },
        Y = function(t) {
          for (var e, n = R(b(t)), r = [], i = 0; n.length > i; )
            o(M, (e = n[i++])) || e == A || e == c || r.push(e);
          return r;
        },
        $ = function(t) {
          for (var e, n = t === q, r = R(n ? I : b(t)), i = [], u = 0; r.length > u; )
            !o(M, (e = r[u++])) || (n && !o(q, e)) || i.push(M[e]);
          return i;
        };
      B ||
        (a(
          (L = function() {
            ...
            return i && G && H(q, t, { configurable: !0, set: e }), z(t);
          }).prototype,
          'toString',
          function() {
            return this._k;
      ...
      u(u.S + u.F * !B, 'Symbol', {
        ...
        L.prototype[D] || n(12)(L.prototype, D, L.prototype.valueOf),
        l(L, 'Symbol'),
        l(Math, 'Math', !0),
        l(r.JSON, 'JSON', !0);
    },
 ...
 */
    ...
    function(t, e, n) {
      ...
      L ||
        ...
        (i = function() {
          var t = new r();
          (this.promise = t), (this.resolve = s(M, t, 1)), (this.reject = s(N, t, 1));
        }),
        (w.f = R = function(t) {
    ...
    function(t, e) {
      !(function(e) {
        ...
        if (f) s && (t.exports = f);
          ...
          var w = (P.prototype = _.prototype = Object.create(y));
          (k.prototype = w.constructor = P),
            (P.constructor = k),
          ...
          (n = [
            {
              ...
              value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                  e = this.storeUrl;
                return t && (e = this.storeQueryUrl), this._getListResourceData(e, t);
              },
            },
            {
              key: 'getPlugin',
              value: function(t) {
                return this._getItemResourceData(this.storeQueryUrl, t);
              },
            },
            {
              ...
              value: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                  n = this.storeQueryUrl;
                return this._getResourceRelatedListData(n, t, 'parameters', e);
              },
            },
            {
              key: 'addPlugin',
              value: function(e, n, r, i) {
                var u = { name: e, dock_image: n, public_repo: i };
                return new o.default(this.auth, this.contentType, this.timeout)
                  .post(this.storeUrl, u, { descriptor_file: r })
                  .then(function(e) {
                    return t.getDataFromCollection(e.data.collection, 'item');
                  });
              },
                        ...
                        function(f) {
                          for (;;)
                            switch ((f.prev = f.next)) {
                              case 0:
                                return (
                                  (l = new o.default(a.auth, a.contentType, a.timeout)),
                                  (f.prev = 1),
                                  (h = { id: e }),
                                  (f.next = 5),
                                  a._fetchCollection(a.storeQueryUrl, h)
                                );
                              case 5:
                                if (!(v = f.sent).items.length) {
                                  f.next = 17;
                                  break;
                                }
                                return (
                                  ...
                                  ((y = {}).public_repo =
                                    n ||
                                    v.items[0].data.filter(function(t) {
                                      return 'public_repo' === t.name;
                                    })[0].value),
                                  u && (y.owner = u),
                                  'application/vnd.collection+json' === a.contentType &&
                                    (y = { template: r.default.makeTemplate(y) }),
                                  (f.next = 14),
                                  l.put(d, y)
                                );
                              case 14:
                                ...
                                break;
                              case 17:
                                throw ((m = 'Could not find resource with id: ' + e),
                                new i.default(m));
                              case 19:
                                f.next = 25;
                                break;
                              case 21:
                                return (
                                  (f.prev = 21), (f.t0 = f.catch(1)), s(f.t0), f.abrupt('return')
                                );
                              case 25:
                                c(t.getDataFromCollection(p.data.collection, 'item'));
                              case 26:
                              case 'end':
                                return f.stop();
                            }
            ...
            },
            {
              key: 'removePlugin',
              value: function(t) {
                return this._removeItemResource(this.storeQueryUrl, t);
              },
            },
            {
              key: 'setPipelinesUrls',
              value: function() {
                var t = this;
                return this._fetchCollection(this.storeUrl).then(function(e) {
                  (t.pipelinesUrl = r.default.getLinkRelationUrls(e, 'pipelines')),
                    (t.pipelinesQueryUrl = t.pipelinesUrl + 'search/');
                });
              },
            },
            {
              ...
              value: function() {
                ...
                return e
                  ? this.pipelinesQueryUrl
                    ? this._getListResourceData(this.pipelinesQueryUrl, e)
                    : this.setPipelinesUrls().then(function() {
                        return t._getListResourceData(t.pipelinesQueryUrl, e);
                      })
                  : this.pipelinesUrl
                    ? this._getListResourceData(this.pipelinesUrl)
                    : this.setPipelinesUrls().then(function() {
                        return t._getListResourceData(t.pipelinesUrl, e);
                      });
              },
            },
            {
              ...
              value: function(t) {
                var e = this;
                return this.pipelinesQueryUrl
                  ? this._getItemResourceData(this.pipelinesQueryUrl, t)
                  : this.setPipelinesUrls().then(function() {
                      return e._getItemResourceData(e.pipelinesQueryUrl, t);
                    });
              },
            },
            {
              key: 'getPipelineDefaultParameters',
              value: function(t) {
                var e = this,
                ...
                return this.pipelinesQueryUrl
                  ...
                  : this.setPipelinesUrls().then(function() {
                      return e._getResourceRelatedListData(
                        e.pipelinesQueryUrl,
                        t,
                        'default_parameters',
                        n
            ...
            {
              key: 'getPipelinePipings',
              value: function(t) {
                var e = this,
                  n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                return this.pipelinesQueryUrl
                  ? this._getResourceRelatedListData(this.pipelinesQueryUrl, t, 'plugin_pipings', n)
                  : this.setPipelinesUrls().then(function() {
                      return e._getResourceRelatedListData(
                        e.pipelinesQueryUrl,
                        t,
            ...
            {
              key: 'getPipelinePlugins',
              value: function(t) {
                var e = this,
                  n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                return this.pipelinesQueryUrl
                  ? this._getResourceRelatedListData(this.pipelinesQueryUrl, t, 'plugins', n)
                  : this.setPipelinesUrls().then(function() {
                      return e._getResourceRelatedListData(e.pipelinesQueryUrl, t, 'plugins', n);
                    });
              },
            },
            {
                          ...
                          for (;;)
                            switch ((s.prev = s.next)) {
                              case 0:
                                ...
                                return (s.next = 6), u.setPipelinesUrls();
                              case 6:
                                return (s.next = 8), u._fetchCollection(u.pipelinesQueryUrl, p);
                              case 8:
                                if (!(h = s.sent).items.length) {
                                  s.next = 17;
                                  break;
                                }
                                return (
                                  (v = h.items[0].href),
                                  'application/vnd.collection+json' === u.contentType &&
                                    (n = { template: r.default.makeTemplate(n) }),
                                  (s.next = 14),
                                  f.put(v, n)
                                );
                              case 14:
                                ...
                                break;
                              case 17:
                                throw ((d = 'Could not find resource with id: ' + e),
                                new i.default(d));
                              case 19:
                                s.next = 25;
                                break;
                              case 21:
                                return (
                                  (s.prev = 21), (s.t0 = s.catch(1)), c(s.t0), s.abrupt('return')
                                );
                              case 25:
                                a(t.getDataFromCollection(l.data.collection, 'item'));
                              case 26:
                              case 'end':
                                return s.stop();
                            }
            ...
            },
            {
              ...
              value: function(t) {
                var e = this;
                return this.pipelinesQueryUrl
                  ? this._removeItemResource(this.pipelinesQueryUrl, t)
                  : this.setPipelinesUrls().then(function() {
                      return e._removeItemResource(e.pipelinesQueryUrl, t);
                    });
              },
            },
            {
            ...
            {
              key: '_getItemResourceData',
              value: function(e, n) {
                var r = { id: n };
                return this._fetchCollection(e, r).then(function(e) {
                  if (e.items.length) return t.getDataFromCollection(e, 'item');
                  var r = 'Could not find resource with id: ' + n;
                  throw new i.default(r);
                });
              },
            },
            {
              key: '_removeItemResource',
              value: function(e, n) {
                var r = this;
                        ...
                        function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (
                                  (c = new o.default(r.auth, r.contentType, r.timeout)),
                                  (s = { id: n }),
                                  (t.prev = 2),
                                  (t.next = 5),
                                  c.get(e, s)
                              ...
                              case 5:
                                if (((f = t.sent), !(l = f.data.collection).items.length)) {
                                  t.next = 14;
                                  break;
                                }
                                return (p = l.items[0].href), (t.next = 11), c.delete(p);
                              case 11:
                                (f = t.sent), (t.next = 16);
                                break;
                              case 14:
                                throw ((h = 'Could not find resource with id: ' + n),
                                new i.default(h));
                              case 16:
                                t.next = 22;
                                break;
                              case 18:
                                return (
                                  (t.prev = 18), (t.t0 = t.catch(2)), a(t.t0), t.abrupt('return')
                                );
                              case 22:
                                u();
                              case 23:
            ...
            {
              key: '_getListResourceData',
              value: function(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                return this._fetchCollection(e, n).then(function(e) {
                  return t.getDataFromCollection(e, 'list');
                });
              },
            },
            {
              key: '_getResourceRelatedListData',
                        ...
                        function(f) {
                          for (;;)
                            switch ((f.prev = f.next)) {
                              case 0:
                                return (
                                  (p = { data: [], hasNextPage: !1, hasPreviousPage: !1 }),
                                  (f.prev = 1),
                                  (f.next = 4),
                                  a._fetchCollection(e, { id: n })
                                );
                              case 4:
                                if (0 !== (l = f.sent).items.length) {
                                  f.next = 8;
                                  break;
                                }
                                throw ((h = 'Could not find resource with id: ' + n),
                                new i.default(h));
                              case 8:
                                if (!(v = r.default.getLinkRelationUrls(l.items[0], o)).length) {
                                  f.next = 14;
                                  break;
                                }
                                return (f.next = 12), a._fetchCollection(v[0], u);
                              case 12:
                                (l = f.sent), (p = t.getDataFromCollection(l, 'list'));
                              case 14:
                                f.next = 20;
                                break;
                              case 16:
                                return (
                                  (f.prev = 16), (f.t0 = f.catch(1)), s(f.t0), f.abrupt('return')
                                );
                              case 20:
                                c(p);
                              case 21:
