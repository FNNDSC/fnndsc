...
This mode is use to have automatically an example corresponding to a patient birthdate and his scan date. It will display the closest example in term of age from the database.
